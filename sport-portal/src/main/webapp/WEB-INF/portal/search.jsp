    ...
    <div id="J_crumbsBar" class="crumbs-bar">
        <div id="J_giftBox" class="cb-gift">
            ...
            <div class="cb-gift-main">
                ...
                <div class="gift-btnbox"><a href="javascript:;"
                                            class="btn btn-primary btn-XL">搜索</a></div>
            </div>
        </div>
                                            ...
                                            <div class="content">
                                                <div data-widget="tabs" class="m JD-stock">
                                                    <div class="mt">
                                                        <ul class="tab">
                                                            <li data-index="0"
                                                                data-widget="tab-item" class=""><a
                                                                    href="javascript:;"
                                                                    class="hover"
                                                                    title="北京"><em>北京</em><i></i></a>
                                                            </li>
                                                            <li data-index="1"
                                                                data-widget="tab-item" style=""
                                                                class=""><a href="javascript:;"
                                                                            class=""
                                                    ...
                                                    <div class="mc" data-area="0"
                                                         data-widget="tab-content"
                                                         style="display: none;">
                                                        <ul class="area-list">
                                                            <li><a href="javascript:;"
                                                                   data-value="1">北京</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2">上海</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="3">天津</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="4">重庆</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="5">河北</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="6">山西</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="7">河南</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="8">辽宁</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="9">吉林</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="10">黑龙江</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="11">内蒙古</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="12">江苏</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="13">山东</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="14">安徽</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="15">浙江</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="16">福建</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="17">湖北</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="18">湖南</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="19">广东</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="20">广西</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="21">江西</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="22">四川</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="23">海南</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="24">贵州</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="25">云南</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="26">西藏</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="27">陕西</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="28">甘肃</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="29">青海</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="30">宁夏</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="31">新疆</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="32">台湾</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="42">香港</a></li>
                                                            <li><a href="javascript:;"
                                                    ...
                                                    <div class="mc" data-area="1"
                                                        ...
                                                        <ul class="area-list">
                                                            <li><a href="javascript:;"
                                                                   data-value="72">朝阳区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2800">海淀区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2801">西城区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2802">东城区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2803">崇文区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2804">宣武区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2805">丰台区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2806">石景山区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2807">门头沟</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2808">房山区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2809">通州区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2810">大兴区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2812">顺义区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2814">怀柔区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2816">密云区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2901">昌平区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="2953">平谷区</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="3065">延庆县</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="mc" data-area="2"
                                                        ...
                                                        <ul class="area-list">
                                                            <li><a href="javascript:;"
                                                                   data-value="2799">三环以内</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="4137">管庄</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="4139">北苑</a></li>
                                                            <li><a href="javascript:;"
                                                                   data-value="4211">定福庄</a></li>
                                                            <li class="long-area"><a
                                                                    href="javascript:;"
                                                                    data-value="2819">三环到四环之间</a>
                                                            </li>
                                                            <li class="long-area"><a
                                                                    href="javascript:;"
                                                                    data-value="2839">四环到五环之间</a>
                                                            </li>
                                                            <li class="long-area"><a
                                                                    href="javascript:;"
                                                                    data-value="2840">五环到六环之间</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="mc" data-area="3"
                                    ...
                                    <div id="J_feature" class="f-feature">
                                        <ul>
                                            <li><a data-field="wtype" data-val="1" class=""
                                                   href="javascript:;"
                                                   onclick="searchlog(1,0,0,43)"><i></i>京东配送</a>
                                            </li>
                                            <li><a data-field="cod" data-val="1" class=""
                                                   href="javascript:;"
                                                   onclick="searchlog(1,0,0,34)"><i></i>货到付款</a>
                                            </li>
                                            <li><a data-field="stock" data-val="1" class=""
                                                   href="javascript:;"
                                                   onclick="searchlog(1,0,0,41)"><i></i>仅显示有货</a>
                                            </li>
                                            <li><a data-field="prom_type" data-val="0" class=""
                                                   href="javascript:;"
                                                   onclick="searchlog(1,0,0,38)"><i></i>促销商品</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div id="J_viewType" class="f-type" data-ref="1">
                                        <a class="ft-item shop" href="javascript:;" data-value="3"
                                           onclick="searchlog(1,0,0,28)"><i
                                                class="i-shop"></i>店铺</a>
                                        <a class="ft-item grid selected" href="javascript:;"
                                        ...
                                        <li data-sku="1711416562" class="gl-item">
                                            <div class="gl-i-wrap">
                                                ...
                                                <div class="p-name p-name-type-2">
                                                    <a target="_blank"
                                                       title="满129立减10,199减20优惠券,支持货到付款"
                                        ...
                                        <li>
                                                ...
                                                <a href="javascript:;"
                                                   ...
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1"
                                                         src="/images/ad3.jpg" class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                            ...
                                            <div class="p-name">
                                                <a target="_blank" href="javascript:;"
                                                   title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L">
                                                    <em>依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子
                                                        L</em>
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:;"
                                                   ...
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1"
                                                         src="/images/ad2.jpg" class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
                                                        <div class="gwd_float_curve_wrapper">
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:;"
                                                   ...
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1"
                                                         src="/images/55237eb5Ndf2c9fcf(1).jpg"
                                                         class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:;"
                                                   ...
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1"
                                                         src="/images/ad4.jpg" class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
                                                        <div class="gwd_float_curve_wrapper">
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:;"
                                                   ...
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1"
                                                         src="/images/ad1.jpg" class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
                                                        <div class="gwd_float_curve_wrapper">
